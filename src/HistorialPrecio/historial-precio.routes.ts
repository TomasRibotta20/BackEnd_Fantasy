...
import { clubIdParamsSchema, jornadaIdParamsSchema, jugadorIdParamsSchema} from './historial-precio.schema.js';
...
historialPrecioRouter.get('/jugador/:jugadorId', requireAuth, validateParams(jugadorIdParamsSchema), HistorialPrecioController.getHistorialPreciosJugador);